...
CREATE TABLE IF NOT EXISTS `bancho_messages` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `msg_from_userid` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bancho_tokens` (
  ...
  `osu_id` int(10) NOT NULL,
  `latest_message_id` int(10) NOT NULL,
  `latest_private_message_id` int(10) NOT NULL,
  `latest_packet_time` int(10) NOT NULL,
  `latest_heavy_packet_time` int(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `beatmaps` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `beatmap_id` int(10) NOT NULL DEFAULT '0',
  `beatmapset_id` int(10) NOT NULL DEFAULT '0',
  ...
  `max_combo` int(10) NOT NULL DEFAULT '0',
  `hit_length` int(10) NOT NULL DEFAULT '0',
  `bpm` int(10) NOT NULL DEFAULT '0',
  `ranked` tinyint(4) NOT NULL DEFAULT '0',
  `latest_update` int(10) NOT NULL DEFAULT '0',
  `ranked_status_freezed` tinyint(1) NOT NULL DEFAULT '0',
  `playcount` int(10) NOT NULL DEFAULT '0',
  `passcount` int(10) NOT NULL DEFAULT '0',
  `disable_pp` int(10) DEFAULT '0',
  `pp_100` int(10) NOT NULL DEFAULT '0',
  `pp_99` int(10) NOT NULL DEFAULT '0',
  `pp_98` int(10) NOT NULL DEFAULT '0',
  `pp_95` int(10) NOT NULL DEFAULT '0',
  `allow_fl` int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  `beatmapset_id` int(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `hw_user` (
  ...
  `occurencies` int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `remember` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `userid` int(10) NOT NULL,
  `series_identifier` int(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `scores` (
  ...
  `max_combo` smallint(5) NOT NULL DEFAULT '0',
  `full_combo` tinyint(1) NOT NULL DEFAULT '0',
  `mods` int(9) NOT NULL DEFAULT '0',
  `300_count` smallint(5) NOT NULL DEFAULT '0',
  `100_count` smallint(5) NOT NULL DEFAULT '0',
  `50_count` smallint(5) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `silence_end` int(10) NOT NULL DEFAULT '0',
  `silence_reason` varchar(127) NOT NULL DEFAULT '',
  `password_version` tinyint(4) NOT NULL DEFAULT '1',
  `privileges` int(10) NOT NULL,
  `donor_expire` int(10) NOT NULL DEFAULT '0',
  `flags` int(10) NOT NULL DEFAULT '0',
  `notes` text,
  `ban_datetime` text,
  `strikes` int(10) NOT NULL DEFAULT '0',
  `nwipes` int(10) NOT NULL DEFAULT '0',
  `cwipes` int(10) NOT NULL DEFAULT '0',
  `achievements_version` int(10) NOT NULL DEFAULT '6',
  `flags_reason` text,
  `aqn` int(10) DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `users_stats` (
  ...
  `playcount_std` int(10) NOT NULL DEFAULT '0',
  ...
  `playcount_taiko` int(10) NOT NULL DEFAULT '0',
  `total_score_taiko` bigint(20) NOT NULL DEFAULT '0',
  `replays_watched_taiko` int(10) NOT NULL DEFAULT '0',
  `ranked_score_ctb` bigint(20) NOT NULL DEFAULT '0',
  `playcount_ctb` int(10) NOT NULL DEFAULT '0',
  `total_score_ctb` bigint(20) NOT NULL DEFAULT '0',
  `replays_watched_ctb` int(10) NOT NULL DEFAULT '0',
  `ranked_score_mania` bigint(20) NOT NULL DEFAULT '0',
  `playcount_mania` int(10) NOT NULL DEFAULT '0',
  `total_score_mania` bigint(20) NOT NULL DEFAULT '0',
  `replays_watched_mania` int(10) unsigned NOT NULL DEFAULT '0',
  `total_hits_std` int(10) NOT NULL DEFAULT '0',
  `total_hits_taiko` int(10) NOT NULL DEFAULT '0',
  `total_hits_ctb` int(10) NOT NULL DEFAULT '0',
  `total_hits_mania` int(10) NOT NULL DEFAULT '0',
  `country` char(2) NOT NULL DEFAULT 'XX',
  `show_country` tinyint(4) NOT NULL DEFAULT '1',
  `level_std` int(10) NOT NULL DEFAULT '1',
  `level_taiko` int(10) NOT NULL DEFAULT '1',
  `level_ctb` int(10) NOT NULL DEFAULT '1',
  `level_mania` int(10) NOT NULL DEFAULT '1',
  ...
  `pp_std` int(10) NOT NULL DEFAULT '0',
  `pp_taiko` int(10) NOT NULL DEFAULT '0',
  `pp_ctb` int(10) NOT NULL DEFAULT '0',
  `pp_mania` int(10) NOT NULL DEFAULT '0',
