...
define('CREATE_ADMIN', 'false');
define('ADMIN_USERNAME', 'ripple');
define('ADMIN_EMAIL', 'admin@ripple.moe');
...
$db->execute("INSERT INTO `users`(`id`, `username`, `username_safe`, `password_md5`, `salt`, `email`, `register_datetime`, `rank`, `allowed`, `latest_activity`, `silence_end`, `silence_reason`, `password_version`, `privileges`, `flags`) VALUES ('999', 'FokaBot', 'fokabot', ?, ?, 'fo@kab.ot', '1452544880', '4', '1', '0', '0', '', 1, 3145727, 0);", [$md5Password, base64_encode($options['salt'])]);
